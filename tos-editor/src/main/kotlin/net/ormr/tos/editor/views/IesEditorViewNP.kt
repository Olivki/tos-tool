...
import net.ormr.tos.editor.controllers.IesEditorControllerNP
...
class IesEditorViewNP(file: Path) : View("IES Editor: ${file.name}") {
    private val controller = IesEditorControllerNP(file)
    private val iesTable get() = controller.iesTable
    private lateinit var tableView: TableView<IesEditorControllerNP.DataRow>
    ...
    override val root = borderpane {
        ...
        center = vbox {
            tableView = tableview<IesEditorControllerNP.DataRow> {
